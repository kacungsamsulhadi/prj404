  ...
  <body>
      ...
      <div class="container">
        <div class="row">
          <div class="col align-self-center">
            <h1 class="mb-4">Cek Penyakit Bearded Dragon</h1>
            <p class="mb-4">
              Temukan Kesehatan Ideal untuk Bearded Dragon Anda! Jelajahi Layanan Cek Penyakit Terpercaya untuk Memastikan Kesejahteraan Reptil Kesayangan Anda. Segera Temukan Solusi yang Tepat untuk Setiap Kondisi Kesehatan.
            </p>
    ...
    <section id="alur">
      ...
      <div id="konten2" class="container konten">
        <h2 style="font-weight: bold;text-align: center;">Alur Kerja Sistem Pakar Cek Penyakit Bearded Dragon</h2>
        <div class="card-deck">
          <div class="card">
          ...
          <div class="card">
            <h5 class="card-title">Test Gejala Bearded Dragon</h5>
            <img src="gambar/jawab.png" class="card-img-top" alt="...">
            <div class="card-body">
              <p class="card-text">Dalam tahap ini pengguna akan diberikan beberapa pertanyaan terkait dengan gejala yang dialami bearded dragon.</p>
            </div>
          </div>
          <div class="card">
